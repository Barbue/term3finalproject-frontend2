...
return (
          ...
          <nav className="navbar"> 
           ...
           {" "} 
           {isVerified && <Link className="link2" to="/wordform"> Word Entry <VscSaveAs /> </Link> }
           {" "} 
           {isVerified && <Link className="link2" to="/expressions"> Expressions</Link> }
            {" "}
           {isVerified && <Link className="link2" to="/expressionform"> Expression Entry <VscSaveAs /></Link> }
           {" "} 
