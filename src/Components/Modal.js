...
const {wordList, urlEndPoint, setShouldRefresh, wordEntry  } = props;  
    ...
    const [exampleSentence, setExampleSentence] = useState(wordEntry.exampleSentence); 
...
const handleUpdateWord1 = () => {
        ...
        const response = axios.put(`${urlEndPoint}/words/update-one/${word.createdById}`, req)
    ...
    <div >
      ...
      >
        ...
        <h1> Edit Word Entry </h1>
          ...
          <Form.Control type="text" value={word} name="word" onChange={(e) => { setWord(e.target.value) }} />
          </FormGroup>
          <br/>
          <FormGroup>
          ...
          <Form.Control type="text"
               value={partOfSpeech}
               name="partOfSpeech"
               onChange={(e) => { setPartOfSpeech(e.target.value) }} as="textarea" rows={3} />
          </FormGroup>
             <br/>
          <FormGroup>
          ...
          <Form.Control type="text" value={exampleSentence}
        ...
        <Modal.Footer>
          ...
          <Button variant="success" onClick={() => {handleUpdateWord1()
         }}>Update Word Entry</Button>  
        </Modal.Footer>
      </Modal>
      </div>
  );
